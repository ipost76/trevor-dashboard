...
/**
 * CategorySettingsSheet — Wave B2.
 *
 * Modal surface for category CRUD: create, rename, delete. Reached from the
 * ⚙️ gear icon on the DOWNLOADS header. Drag-reorder is intentionally NOT
 * implemented this wave — no drag-and-drop library is installed and the
 * prompt's hard constraint forbids adding one just for reorder.
 *
 * Wiring:
 ...
 * - Uncategorized is rendered last and is locked (no rename, no delete).
